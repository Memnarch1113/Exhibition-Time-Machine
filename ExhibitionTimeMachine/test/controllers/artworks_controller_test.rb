...
class ArtworksControllerTest < ActionController::TestCase
  ...
  test "should create artwork" do
    assert_difference('Artwork.count') do
      post :create, artwork: { artist_id: @artwork.artist_id, description: @artwork.description, images_dir: @artwork.images_dir, title: @artwork.title }
    end
  ...
  test "should update artwork" do
    patch :update, id: @artwork, artwork: { artist_id: @artwork.artist_id, description: @artwork.description, images_dir: @artwork.images_dir, title: @artwork.title }
    assert_redirected_to artwork_path(assigns(:artwork))
  end
